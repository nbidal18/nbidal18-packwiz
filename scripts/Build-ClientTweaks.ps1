...
$destination = Join-Path $clientMods 'nbidal18-client-tweaks-1.2.1+1.21.1.jar'
...
if ($installed.Count -ne 1 -or $installed[0].Name -ne 'nbidal18-client-tweaks-1.2.1+1.21.1.jar') {
