...
function Build-Jar([string] $workRoot, [string] $jarPath) {
    ...
    $manifestText = "Manifest-Version: 1.0`r`nMain-Class: dev.nbidal18.launchguard.LaunchGuard`r`nImplementation-Title: nbidal18-launch-guard`r`nImplementation-Version: 1.0.0`r`n`r`n"
